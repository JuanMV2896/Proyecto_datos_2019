...
${OBJECTDIR}/Integer.o: Integer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -include stack.h -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Integer.o Integer.cpp

${OBJECTDIR}/Utiles.o: Utiles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -include stack.h -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Utiles.o Utiles.cpp

${OBJECTDIR}/coleccion.o: coleccion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -include stack.h -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coleccion.o coleccion.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -include stack.h -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/objetoBase.o: objetoBase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -include stack.h -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objetoBase.o objetoBase.cpp
